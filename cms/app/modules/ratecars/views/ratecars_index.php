		...
		<div class="card">
			<div class="card-close">
				<!-- <div class="card-buttons">
					<?php if ($this->acl->restrict('ratecars.ratecars.add', 'return')): ?>
						<a href="<?php echo site_url('ratecars/ratecars/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div> -->
			</div>
			...
			<div class="card-body">				
				...
				<th class="all"><?php echo lang('index_car_model_id'); ?></th>
				<th class="min-desktop"><?php echo lang('index_rate'); ?></th>
				<th class="min-desktop"><?php echo lang('index_rent_hr'); ?></th>
