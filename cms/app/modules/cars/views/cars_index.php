		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('cars.cars.add', 'return')): ?>
						<a href="<?php echo site_url('cars/cars/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
			...
			<div class="card-body">				
				...
				<th class="all"><?php echo lang('index_model'); ?></th>
				<th class="min-desktop"><?php echo lang('index_model_type'); ?></th>
				<th class="min-desktop"><?php echo lang('index_year'); ?></th>
