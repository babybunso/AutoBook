...
<head>
	...
	<link rel="stylesheet" href="<?php echo site_url('themes/material/css/src/style.green.css'); ?>" id="theme-stylesheet">
			...
			<div class="content-inner">
				...
				<footer class="main-footer">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<p>&copy; <?php echo date('Y'); ?> <?php echo config_item('app_name'); ?> v.<?php echo config_item('app_version'); ?> /   v.<?php echo CF_VERSION; ?></p>
							</div>
